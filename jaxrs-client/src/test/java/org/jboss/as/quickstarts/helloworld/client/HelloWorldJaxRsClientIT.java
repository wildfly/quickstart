...
import org.jboss.as.quickstarts.helloworld.server.JaxRsActivator;
...
@RunAsClient
public class HelloWorldJaxRsClientIT {
    ...
    private String getRequestUrl(String verb, String format) {
        return new StringBuilder(deploymentUrl.toString())
                .append("rest/" + verb + "/" + format)
                .toString();
    }

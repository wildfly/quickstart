...
Inspect the content in `src/main/webapp/META-INF/singleton-deployment.xml`.
...
. Move the `src/main/webapp/META-INF/singleton-deployment.xml` file into root directory of this quickstart.

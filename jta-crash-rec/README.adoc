...
** Log out of the H2 console and be sure to close out the terminal. H2 is limited to one connection and the application will need it from this point forward.

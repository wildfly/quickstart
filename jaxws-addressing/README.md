...
The `jaxws-addressing` quickstart demonstrates the use of *JAX-WS* in ${product.name.full} as a simple WS-addressing application.
...
You can check that the Web Service is running and deployed correctly by accessing the following URL: <http://localhost:8080/${project.artifactId}/AddressingService?wsdl>. This URL will display the deployed WSDL endpoint for the Web Service.

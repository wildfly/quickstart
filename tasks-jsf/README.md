...
The `tasks-jsf` quickstart demonstrates how to use JPA persistence with JSF as view layer in an application deployed to ${product.name.full}. It provides a JSF front end for the [tasks](../tasks/README.md) quickstart.

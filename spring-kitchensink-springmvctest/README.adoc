...
= spring-kitchensink-springmvctest: Kitchensink MVC Example Using Spring
...
The `spring-kitchensink-springmvctest` quickstart demonstrates how to create an MVC application using JSP, JPA and Spring 5.x in {productNameFull}.

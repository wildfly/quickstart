...
Next you need to start {productName} with the XTS subsystem enabled. This is enabled through the optional server configuration _standalone-xts.xml_. To do this, run the following commands from the top-level directory of {productName}:

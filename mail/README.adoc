...
[subs="+quotes,attributes+"]
----
For Linux: {jbossHomeName}/bin/jboss-cli.sh --connect --file=configure-mail-session.cli
For Windows: {jbossHomeName}\bin\jboss-cli.bat --connect --file=configure-mail-session.cli
----
...
[subs="+quotes,attributes+"]
----
For Linux: {jbossHomeName}/bin/jboss-cli.sh --connect --file=remove-mail-session.cli
For Windows: {jbossHomeName}\bin\jboss-cli.bat --connect --file=remove-mail-session.cli
----

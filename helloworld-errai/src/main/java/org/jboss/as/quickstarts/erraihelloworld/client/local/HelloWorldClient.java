...
/**
 * Companion class to the UI declared in {@linkplain HelloWorldClient.ui.xml}. Handles events and updates the DOM in response.
 * 
...
public class HelloWorldClient {
    ...
    /**
     * Handles a click of the button by sending an AJAX request to the HelloWorldResourceImpl and then updating the
     * {@code result} label in response.
     * 

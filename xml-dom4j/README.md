...
The `xml-dom4j` quickstart is a simple DOM4J example that demonstrates how to use Servlet 3.0 and JSF to upload an XML file to *WildFly Application Server* and parse it using a 3rd party XML parsing library.
...
4. This will deploy `target/xml-dom4j.war` to the running instance of the server.

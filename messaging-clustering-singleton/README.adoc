...
//*************************************************
// Start the server as a managed domain
//*************************************************
...
//*************************************************
// == Start the Server with the Full HA Profile
include::../shared-doc/start-server-full-ha-profile.adoc[leveloffset=+3]
...
. xref:start_eap_in_a_managed_domain[Start the {productName} managed domain] as described above.

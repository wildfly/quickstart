...
. link:../jts/README.md[jts] - The JTS quickstart builds upon this quickstart by distributing the CustomerManager and InvoiceManager
. link:../jts-distributed-crash-rec/README.md[jts-distributed-crash-rec] - The crash recovery quickstart builds upon the link:../jts/README.md[jts] quickstart by demonstrating the fault tolerance of {productName}.

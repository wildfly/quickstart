...
:WildFlyQuickStartRepoTag: 34.0.0.Beta1
:DocInfoProductName: Red Hat JBoss Enterprise Application Platform
:DocInfoProductNameURL: red_hat_jboss_enterprise_application_platform
...
[source,bash]
----
$ curl http://localhost:8080/microprofile-lra/rest/participant1/work
----
...
[source,bash]
----
$ curl "http://localhost:8080/microprofile-lra/rest/participant1/work?failLRA=true"
----

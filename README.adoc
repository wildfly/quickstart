...
We recommend using the *{quickstartDownloadName}* ZIP file, which can be downloaded from {quickstartDownloadUrl}. This version of the quickstarts uses the correct dependencies and ensures that you test and compile against the correct runtime environment.

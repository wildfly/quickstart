...
[subs="+quotes,attributes+"]
----
For Linux: $ __{jbossHomeName}__/bin/jboss-cli.sh --connect --file=configure-server.cli
For Windows: __{jbossHomeName}__\bin\jboss-cli.bat --connect --file=configure-server.cli
----
...
[subs="+quotes,attributes+"]
----
For Linux: $ __{jbossHomeName}__/bin/jboss-cli.sh --connect --file=restore-configuration.cli
For Windows: __{jbossHomeName}__\bin\jboss-cli.bat --connect --file=restore-configuration.cli
----

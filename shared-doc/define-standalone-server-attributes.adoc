...
:serverArgumentsMavenPlugin: -Dserver-config=standalone/configuration/standalone-full.xml
endif::[]
...
:serverArgumentsMavenPlugin: -Dserver-config=standalone/configuration/standalone-full-ha.xml
endif::[]
...
:serverArgumentsMavenPlugin: -Dserver-config=standalone/configuration/standalone-ha.xml
endif::[]
...
:serverArgumentsMavenPlugin: -Dserver-config=standalone/configuration/standalone-microprofile.xml
endif::[]

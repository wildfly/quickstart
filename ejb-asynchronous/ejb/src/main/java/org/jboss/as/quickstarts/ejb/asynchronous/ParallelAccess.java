...
@Remote
public interface ParallelAccess {
    ...
    /**
     * Demonstrate a parallel execution of different annotated asynchronous methods. The result will be shown in the servers
     * logfile.
     */
    void callInterfaceAnnotatedMethod();

...
public class JMSClientUtil
{
    ...
    public static ConnectionFactory getConnectionFactory() throws Exception
    {
        ...
        try
        {
            String connType = (System.getProperty("connection.type") == null) ? DEFAULT_CONN_TYPE : System.getProperty("connection.type");
    ...
    public static Destination getDestination() throws Exception
    {
        ...
        {
            String connType = (System.getProperty("connection.type") == null) ? DEFAULT_CONN_TYPE : System.getProperty("connection.type");
            String destName = (System.getProperty("dest.name") == null) ? DEFAULT_DESTINATION_JNDI : System.getProperty("dest.name");

 ...
 */
package org.jboss.as.quickstarts.kitchensink.spring.asyncrequestmapping.model;
...
@Entity
@Table(name = "MemberAsync", uniqueConstraints = @UniqueConstraint(columnNames = "email"))

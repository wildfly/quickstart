...
* Be sure to replace the `__QUICKSTART_NAME__` and `__YOUR_NAME__` variables in your `README.adoc` file with the appropriate values.
...
The `__QUICKSTART_NAME__` quickstart demonstrates … in {productNameFull}.

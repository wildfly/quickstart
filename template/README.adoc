...
////
    ...
    * It uses the H2 database. Make sure you define the `:uses-h2:` variable.
    * It uses a `*-ds.xml` file. Make sure you define the `:uses-ds-xml:` variable.
...
//*************************************************
// Build and deploy the quickstart archiveType
//*************************************************
// == Build and Deploy the Quickstart
// Define the archiveType, for example:
// :archiveType: ear
// To override the Maven command, define the `mavenCommand` variable, for example:
// :mavenCommand: mvn clean install wildfly:deploy

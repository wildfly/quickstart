...
This quickstart demonstrates the use of  JMS clients with WildFly 8 using DeltaSpike configuration properties.

It contains the following:

1. A message producer that sends messages to a JMS destination deployed to a WildFly 8 server.

2. A message consumer that receives message from a JMS destination deployed to a WildFly 8 server.

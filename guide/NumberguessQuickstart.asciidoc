...
This quickstart shows you how to create and deploy a simple application to WildFly 8; the application does not persist any information. Information is displayed using a JSF view, and business logic is encapsulated in two CDI beans.

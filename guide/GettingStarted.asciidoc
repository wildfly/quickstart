Getting started with JBoss Enterprise Application Platform or WildFly 8
========================================================================
:Author: Pete Muir
...
Now, you need to choose either WildFly 8. If you choose WildFly 8, make sure you have:

The WildFly 8 runtime::
  TODO

The WildFly 8 quickstarts::
  TODO

If you choose WildFly 8, make sure you have:

The WildFly 8 runtime::
  Download WildFly 8 from the link:http://jboss.org/jbossas/downloads[JBoss AS download page]
...
[TIP]
========================================================================
WildFly 8 and WildFly 8 offer the
...
WildFly 8 also offers a standalone mode, which is perfect for a single
...
Next, we need to choose a location for JBoss AS to live. By default, WildFly 8 will be extracted into `jboss-as-7.x.x.x` (where `7.x.x.x` matches the version you downloaded):
...
link:http://docs.redhat.com/docs/en-US/JBoss_Enterprise_Application_Platform/6/html/Administration_and_Configuration_Guide/index.html[Administration and Configuration Guide for WildFly 8] or the
link:https://docs.jboss.org/author/display/AS71/Getting+Started+Guide[Getting Started Guide for WildFly 8]
...
Next, we need to choose a location for WildFly 8 or JBoss AS to live. By default, WildFly 8 will be extracted into `jboss-as-7.x.x.x` (where `7.x.x.x` matches the version you downloaded). Unzip JBoss Enterprise Application Platform or WildFly 8 using your tool of choice.

Finally, let's start JBoss Enterprise Application Platform or WildFly 8 in standalone mode. Locate your installation and run `standalone.bat` located in `bin`.
...
That's it, WildFly 8 is installed and running! Visit http://localhost:8080/ to check the server has started properly.
...
You may choose to use JBoss Developer Studio, or Eclipse with JBoss Tools, rather than the command line to run WildFly 8, and to deploy the quickstarts. If you don't wish to use Eclipse, you should skip this section.
...
Here we will quickly outline how you can access both the command line interface and the web management interface for managing WildFly 8. Detailed information for both can be found in the link:http://docs.redhat.com/docs/en-US/JBoss_Enterprise_Application_Platform/6/html/Administration_and_Configuration_Guide/index.html[Administration and Configuration Guide for WildFly 8] or the link:https://docs.jboss.org/author/display/AS71/Admin+Guide[Admin Guide for WildFly 8].
...
WildFly 8 and WildFly 8 also comes with a command line interface. To run it on Linux, Unix or Mac, execute:

...
To add the user, open a terminal and type the following commands:
...
. If you choose to run the script to suppress system exceptions, run the following command, replacing `__{jbossHomeName}__` with the path to your server:
+
[source, subs=normal]
----

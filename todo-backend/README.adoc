...
[source,options="nowrap",subs="+attributes"]
----
$ helm install todo-backend -f https://raw.githubusercontent.com/jbossas/eap-charts/main/examples/eap-xp3/todo-backend/todo-backend-bootable-jar.yaml jboss-eap/eap-xp3
NAME: todo-backend
...
STATUS: deployed
REVISION: 1
...
[source,options="nowrap",subs="+attributes"]
----
$ helm install todo-backend -f https://raw.githubusercontent.com/jbossas/eap-charts/main/examples/eap-xp3/todo-backend/todo-backend-s2i.yaml jboss-eap/eap-xp3
NAME: todo-backend
...
STATUS: deployed
REVISION: 1

...
NAME                    CHART VERSION   APP VERSION     DESCRIPTION
jboss-eap/eap7          ...             ...             A Helm chart to build and deploy EAP 7 applic...
----
endif::[]
...
[source,options="nowrap"]
----
$ helm install todo-backend -f todo-backend-bootable-jar.yaml wildfly/wildfly
NAME: todo-backend
...
STATUS: deployed
REVISION: 1
...
[source,options="nowrap"]
----
$ helm install todo-backend -f todo-backend-s2i.yaml wildfly/wildfly
NAME: todo-backend
...
STATUS: deployed
REVISION: 1
...
[source,options="nowrap"]
----
$ helm install todo-backend -f todo-backend-s2i.yaml jboss-eap/eap7
NAME: todo-backend
...
STATUS: deployed
REVISION: 1

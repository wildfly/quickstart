...
This example demonstrates the use of *CDI 1.0* and *PicketLink* in *WildFly 8* or *WildFly 8*.
...
The application will be running at the following URL: <http://localhost:8080/jboss-as-picketlink-authentication>. 

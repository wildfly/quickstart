...
Run the above command first in the `country-server` directory and then in the
`country-client` directory. It is important to do your deployments in this order as

 ...
 * <li>v1.5.1 - Fixed bug when decompressing and decoding to a byte[] using <tt>decode(
 * String s, boolean gzipCompressed )</tt>. Added the ability to "suspend" encoding in the Output Stream so you can turn on and
 * off the encoding if you need to embed base64 data in an otherwise "normal" stream (like an XML file).</li>
    ...
    private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset) {
        ...
        // Example: DkLE
            ...
            try {
                ...
                System.err.println("" + source[srcOffset] + ": " + (DECODABET[source[srcOffset]]));
                System.err.println("" + source[srcOffset + 1] + ": " + (DECODABET[source[srcOffset + 1]]));
                System.err.println("" + source[srcOffset + 2] + ": " + (DECODABET[source[srcOffset + 2]]));
                System.err.println("" + source[srcOffset + 3] + ": " + (DECODABET[source[srcOffset + 3]]));
                return -1;
            } // end catch
        }
    } // end decodeToBytes

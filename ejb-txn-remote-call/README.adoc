...
The server provisioning functionality is provided by the {productName} Maven Plugin, and you may find its configuration in the pom.xml files of the quickstart.
...
a PostgreSQL database will be deployed on the OpenShift instance using a simple Helm chart:

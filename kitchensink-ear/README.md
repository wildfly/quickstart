...
you get your feet wet with database access in enterprise Java. This project 
is similar to the jboss-as-kitchensink example, however, this one generates 
an EAR instead of a WAR.
...
The application will be running at the following URL:
           <http://localhost:8080/jboss-as-kitchensink-ear/>.
